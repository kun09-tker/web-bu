                    ...
                    <div id="my-cv" class="container user-cv">
                        <div id="cv-left" class="col-md-3 col-sm-12 white">
                            <div id="user-profile">
                                ...
                                <input type="file" class="inputAvt" style="display: none;">
                                <p class="idUser" style="display: none;"><?php echo $userRank ?></p>
                            ...
                            <div id="infomation">
                                <h3>
                                    Thông tin
                                    <i style="display: none;" data-toggle="modal" data-target="#modal-edit-achievement" id="edit-achievement" class="cl-icon-pen pull-right" style="margin-right:12px;">
